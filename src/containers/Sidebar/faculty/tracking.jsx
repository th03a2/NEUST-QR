...
import { faUserLock, faBookOpen, faClipboard } from '@fortawesome/free-solid-svg-icons'
    ...
    return (
      <SidebarWrapper>
        <Sider
          ...
          style={styling}
        >
          <Logo collapsed={collapsed} platform={platform} link="tracking/newsfeed" />
          <Scrollbars renderView={this.renderView} style={{ height: scrollheight - 70 }}          >
            ...
            >
              <Menu.Item key="doc">
                <Link className="isoMenuHolder" style={submenuColor} to={`${url}/tracking/doc`}>
